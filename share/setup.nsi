...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:NFTY"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\NFTY\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\NFTY.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\NFTY.lnk"
