...
static const int64_t BLOCK_SPACING_MIN = (3.5 * 60); // Four-and-a-Half minutes (3 Min, 30 Sec)
...
inline int64_t MasternodeCollateral(int nHeight) { return 50000; } // 50 thousand NFTY required as collateral
