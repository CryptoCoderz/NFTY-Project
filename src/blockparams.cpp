...
// Copyright (c) 2020 The NFTY project
...
//
//
// Reward calculations for 13-years of NFTY emissions
// 21 Million Total     | 14,000,000 Premine (For Swap)
// 100% Remaining NFTY :  7,000,000 (Mineable)
// ----------------------------------
...
// Payout per block     : 5 NFTY
// Payout per day       : 5 * ((1 * 60 * 60) / (5 * 60) * 24)                   =       1,440 NFTY
// Payout per month     : 5 * (((1 * 60 * 60) / (5 * 60) * 24) * 30)            =      43,200 NFTY
// Payout per year      : 5 * (((1 * 60 * 60) / (5 * 60) * 24) * 365)           =     525,600 NFTY
// Mineout (13 Years)   : 5 * (13.32 * (((1 * 60 * 60) / (5 * 60) * 24) * 365))	=  21,000,000 NFTY
// ----------------------------------
// (Network Allocation) (BLOCKS | 13-Years of minting)
// Singular Payout      : 1.25 NFTY
// Maternode Payout     : 3.50 NFTY
// DevOps Payout        : 0.25 NFTY
// Total Payout (Block) : 5.00 NFTY
// ----------------------------------
// (PLEASE NOTE)
...
{
    int64_t ret2 = 0;
    ret2 = (0.25) * COIN; // 12.5 NFTY per block = 10% of blocks.
