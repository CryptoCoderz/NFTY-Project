...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeNFTYersed READ rangeNFTYersed WRITE setRangeNFTYersed)
...
public:
  ...
  */
  ...
  bool rangeNFTYersed() const { return mRangeNFTYersed; }
  ...
  void setRangeNFTYersed(bool reversed);
