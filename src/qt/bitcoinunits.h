...
/** NFTY unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NFTYUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NFTYUnits(QObject *parent);
...
typedef NFTYUnits::Unit NFTYUnit;
