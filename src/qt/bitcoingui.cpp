...
NFTYGUI::NFTYGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("NFTY") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("NFTY");
    setStyleSheet("#NFTY { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void NFTYGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a NFTY address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About NFTY"), this);
    aboutAction->setToolTip(tr("Show information about NFTY"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for NFTY"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit NFTY.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for NFTY"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit NFTY.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for NFTY (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where NFTY data is stored"));
...
void NFTYGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolBar { background: none; } QToolButton { color: #ffffff; background: none; } QToolButton:hover { background-color: rgb(186, 150, 64, 0.4); } QToolButton:checked { background-color: rgb(186, 150, 64, 0.4); } QToolButton:pressed { background-color: rgb(186, 150, 64, 0.4); } #tabs { color: #ffffff; background: none; border: none;}");
    toolbar->setIconSize(QSize(64,64));

    if(!fUseDarkTheme)
    {
        toolbar->setStyleSheet("QToolBar { background: none; } QToolButton { color: #ffffff; background: none;} QToolButton:hover { background-color: rgb(186, 150, 64, 0.4); } QToolButton:checked { background-color: rgb(186, 150, 64, 0.4); } QToolButton:pressed { background-color: rgb(186, 150, 64, 0.4); } #tabs { color: #ffffff; background: none; border: none;}");//QToolBar { background: none; }
    }
...
void NFTYGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("NFTY client") + QString(" ") + tr("[testnet]"));
...
void NFTYGUI::setWalletModel(WalletModel *walletModel)
{
...
void NFTYGUI::setMessageModel(MessageModel *messageModel)
{
...
void NFTYGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("NFTY client"));
...
#ifndef Q_OS_MAC
void NFTYGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void NFTYGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void NFTYGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void NFTYGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NFTY network", "", count));
}

void NFTYGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void NFTYGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("NFTY") + " - ";
...
void NFTYGUI::error(const QString &title, const QString &message, bool modal)
{
...
void NFTYGUI::changeEvent(QEvent *e)
{
...
void NFTYGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void NFTYGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(NFTYUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void NFTYGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(NFTYUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void NFTYGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void NFTYGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#NFTY { background-image: url(:/images/background_light_alt); }");
}

void NFTYGUI::gotoBlockBrowser()
{
...
void NFTYGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#NFTY { background-image: url(:/images/background_light); }");
}

void NFTYGUI::gotoHistoryPage()
{
...
void NFTYGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void NFTYGUI::gotoAddressBookPage()
{
...
void NFTYGUI::gotoReceiveCoinsPage()
{
...
void NFTYGUI::gotoSendCoinsPage()
{
...
void NFTYGUI::gotoSignMessageTab(QString addr)
{
...
void NFTYGUI::gotoVerifyMessageTab(QString addr)
{
...
void NFTYGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void NFTYGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NFTY address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void NFTYGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void NFTYGUI::setWalletUnlockStakingOnly()
{
...
void NFTYGUI::setEncryptionStatus(int status)
{
...
void NFTYGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void NFTYGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void NFTYGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void NFTYGUI::updateStakingIcon()
{
    updateWeight();
...
void NFTYGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void NFTYGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
