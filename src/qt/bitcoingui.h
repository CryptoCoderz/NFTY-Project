...
/**
  NFTY GUI main class. This class represents the main window of the NFTY UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NFTYGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit NFTYGUI(QWidget *parent = 0);
    ~NFTYGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a NFTY  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
